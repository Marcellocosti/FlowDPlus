...
for dir in "${pt_dirs[@]}"; do
    ...
    python3 ~/alice/DmesonAnalysis/run3/flow/systematics/compute_syst_multitrial_bdt.py "$dir" "/home/mdicosta/FlowDplus/FinalResults/4050final/cutvar_combined_improved/" -o $dir --prompt
