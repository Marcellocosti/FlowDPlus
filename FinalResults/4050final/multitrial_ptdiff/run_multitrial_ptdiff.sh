...
export config_modifies="/home/mdicosta/FlowDplus/FinalResults/4050final/multitrial_ptdiff/fit_config_modifications.yml"
...
export output_dir="/home/mdicosta/FlowDplus/FinalResults/4050final/multitrial_ptdiff"
export syst_paths=$output_dir
export multitrial_config_path="/home/mdicosta/FlowDplus/FinalResults/4050final/multitrial_ptdiff"
...
pt_dirs=("$multitrial_config_path/pt_120_160")
...
for dir in "${pt_dirs[@]}"; do
    ...
    python3 ~/alice/DmesonAnalysis/run3/flow/systematics/compute_syst_multitrial_bdt.py "$dir" "/home/mdicosta/FlowDplus/FinalResults/4050final/cutvar_combined/" -o $dir --prompt
