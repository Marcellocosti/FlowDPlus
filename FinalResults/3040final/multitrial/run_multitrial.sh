...
export config_modifies="/home/mdicosta/FlowDplus/FinalResults/3040final/multitrial/fit_config_modifications.yml"
...
export suffix="multitrial_3040"
export output_dir="/home/mdicosta/FlowDplus/FinalResults/3040final/multitrial/"
export syst_paths=$output_dir
export multitrial_config_path="/home/mdicosta/FlowDplus/FinalResults/3040final/multitrial/config_sys/all_pt"
...
python3 ~/alice/DmesonAnalysis/run3/flow/systematics/compute_syst_multitrial_bdt.py ${all_v2_files[@]} -s Dplus_multitrial_3040 -o $output_dir