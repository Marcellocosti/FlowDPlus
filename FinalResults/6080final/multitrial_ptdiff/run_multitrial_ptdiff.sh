...
export config_modifies="/home/mdicosta/FlowDplus/FinalResults/6080final/multitrial_ptdiff/fit_config_modifications.yml"
...
export output_dir="/home/mdicosta/FlowDplus/FinalResults/6080final/multitrial_ptdiff"
export syst_paths=$output_dir
export multitrial_config_path="/home/mdicosta/FlowDplus/FinalResults/6080final/multitrial_ptdiff"
...
for dir in "${pt_dirs[@]}"; do
    ...
    python3 ~/alice/DmesonAnalysis/run3/flow/systematics/compute_syst_multitrial_bdt.py "$dir" "/home/mdicosta/FlowDplus/FinalResults/6080final/cutvar_combined/" -o $dir --prompt
