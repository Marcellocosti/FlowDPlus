...
export config_flow="/home/mdicosta/FlowDplus/FinalResults/ryeval/3040/notempls/config_3040_rynotempls_parallel.yml"
...
python3 run_cutvar_parallel.py $config_flow \
							   $usepreprocessed \
							   $calc_weights \
							   $make_yaml \
							   $proj_data \
